                    ...
                    <div class="box">
                      <h2>Cadastro</h2><br>
                        <form action="login.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input name="usuario" class="input is-large" type="text"  placeholder="Seu usuário" autofocus="">
                                </div>
                            </div>
                            ...
                            <div class="field">
                                <div class="control">
                                    <input name="instituicao" class="input is-large" type="text" placeholder="Instituição">
                                </div>
                            </div>
